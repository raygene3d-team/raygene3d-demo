...
VK_BINDING(8) Texture2D<float4> render_target_0 : register(t5);
VK_BINDING(9) Texture2D<float4> render_target_1 : register(t6);
VK_BINDING(10) Texture2D<float4> render_target_2 : register(t7);

VK_BINDING(11) Texture2D<float> depth_texture : register(t8);
VK_BINDING(12) RWTexture2D<float4> out_buffer : register(u0);
